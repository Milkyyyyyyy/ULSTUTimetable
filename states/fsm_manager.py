"""
Восстановление состояний FSM при перезапуске бота.
При старте все ранее зарегистрированные пользователи возвращаются
в состояние MainMenu.main_menu, чтобы кнопки меню оставались рабочими.
"""
